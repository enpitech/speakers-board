  ...
  return (
    <div className={cn("w-full", className)}>
      ...
      <div
        ...
        className={cn(
          "flex min-h-[42px] w-full flex-wrap gap-2 rounded-md border border-stroke bg-background-2 p-2 transition-colors hover:border-dark-base focus-within:border-primary",
