...
import type { SocialLink, SocialNetwork, SocialNetworkOption } from '../types';

export const useSocialNetworks = (value: SocialLink, onChange: (value: SocialLink) => void) => {
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      window.addEventListener('scroll', handlePositionUpdate, { signal: abortController.signal });
      window.addEventListener('resize', handlePositionUpdate, { signal: abortController.signal });
